...
extension MessageView {
    ...
    public func configureTheme(_ theme: Theme, iconStyle: IconStyle = .default) {
        ...
        case .success:
            let backgroundColor = #colorLiteral(red: 0.08235294118, green: 0.7098039216, blue: 0.5647058824, alpha: 1)
        ...
        case .warning:
            ...
            configureTheme(backgroundColor: backgroundColor, foregroundColor: foregroundColor, iconImage: iconImage)
        case .error:
            let backgroundColor = #colorLiteral(red: 1, green: 0.292295317, blue: 0.2976712415, alpha: 1)
            let foregroundColor = UIColor.white
            configureTheme(backgroundColor: backgroundColor, foregroundColor: foregroundColor, iconImage: iconImage)
        }
    }
